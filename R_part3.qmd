...
## Filtering {data-auto-animate="true"}

::: {style="font-size: 90%;" data-id="filter-intro"}
Done using the <kbd>filter</kbd> function: subsets a data frame, retaining all rows that satisfy your conditions.
...
::: {style="font-size: 90%;" data-id="filter-intro"}
Done using the <kbd>mutate()</kbd> function: creates new or modifies existing variables in the object
